...
namespace RBAC_Automation
{
    ...
    public class SampleConfiguration
    {
        ...
        public string ClientId = Environment.GetEnvironmentVariable("RBAC_Automation:ClientId");
        ...
        public string Authority
        {
            get
            {
                string instance = Environment.GetEnvironmentVariable("RBAC_Automation:Instance");
                string tenantId = Environment.GetEnvironmentVariable("RBAC_Automation:Tenant");
